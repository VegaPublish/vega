...
describe('number', () => {
  ...
  test('min constraint', async () => {
    ...
    await expect(rule.validate(10)).resolves.toMatchSnapshot(
      'min: valid, at limit'
    )
  ...
  test('integer constraint', async () => {
    ...
    await expect(rule.validate(31.14)).resolves.toMatchSnapshot(
      'integer: invalid (float)'
    )
  ...
  test('precision constraint', async () => {
    ...
    await expect(rule.validate(Math.PI)).resolves.toMatchSnapshot(
      'precision: invalid (pi)'
    )
    await expect(rule.validate(31.133)).resolves.toMatchSnapshot(
      'precision: valid (at limit)'
    )
    await expect(rule.validate(31.3)).resolves.toMatchSnapshot(
  ...
  test('positive constraint', async () => {
    ...
    await expect(rule.validate(0)).resolves.toMatchSnapshot(
      'positive: valid (zero)'
    )
