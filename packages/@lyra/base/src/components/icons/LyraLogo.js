...
export default class LyraLogoIcon extends React.PureComponent {
  render() {
    return (
      <IconBase viewBox="0 0 1024 1024" {...this.props}>
        <g className="lyraIconAnimate">
          <path
            className="lyraIconTop"
