...
import {addLocaleData, IntlProvider} from 'part:@lyra/base/locale/intl'
import {IntlWrapper} from 'part:@lyra/base/locale/formatters'

import {resolveLanguage} from 'part:@lyra/base/language-resolver'
import messageFetcher from 'part:@lyra/base/locale-message-fetcher'
import Spinner from 'part:@lyra/components/loading/spinner'

class LyraIntlProvider extends React.Component {
  constructor(props) {
    super(props)
...
export default LyraIntlProvider
