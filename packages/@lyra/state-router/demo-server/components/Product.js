  ...
  render() {
    ...
    return (
      <div>
        ...
        <StateLink state={{id, detailView: 'details'}}>
          View more details
        </StateLink>
        <p>
          <StateLink state={{id: nextProductId}}>
        ...
        <p>
          <WithRouter>
            {router => (
              <button
                onClick={() =>
                  router.navigateIntent('open', {type: 'product', id: 'foobar'})
                }
              >
                Click to programmatically navigate to intent <b>open:</b>{' '}
                product foobar
              </button>
            )}
          </WithRouter>
        ...
        <WithRouter>
          {router => <pre>{JSON.stringify(router.state)}</pre>}
        </WithRouter>
        <p>
