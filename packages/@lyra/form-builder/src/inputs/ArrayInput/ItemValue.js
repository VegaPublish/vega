...
import Popover from 'part:@lyra/components/dialogs/popover'
...
import {createDragHandle} from 'part:@lyra/components/lists/sortable'
...
function hasFocusInPath(path, value) {
  return (
    path.length === 1 &&
    PathUtils.isSegmentEqual(path[0], pathSegmentFrom(value))
  )
}
