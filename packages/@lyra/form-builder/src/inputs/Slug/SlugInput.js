    ...
    class SlugInput extends React.Component {
      ...
      handleGenerateSlug = () => {
        ...
        if (!source) {
          ...
          console.error(
            `Source is missing. Check source on type "${type.name}" in schema`
          )
          return
        }
            ...
            <div className={styles.wrapper}>
              <div className={styles.input}>
                <TextInput
                  ...
                  customValidity={
                    errors.length > 0 ? errors[0].item.message : ''
                  }
                  disabled={loading}
                  ...
                  value={
                    typeof inputText === 'string' ? inputText : value.current
                  }
                />
              </div>
