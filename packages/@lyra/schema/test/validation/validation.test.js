...
import object from '../../src/lyra/validation/types/object'
import array from '../../src/lyra/validation/types/array'
...
test('Validation test', () => {
  const validation = traverseSchema(
    schemaDef,
    coreTypes,
    (typeDef, visitorContext) => {
