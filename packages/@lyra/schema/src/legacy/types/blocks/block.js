...
export const BlockType = {
  ...
  extend(subTypeDef, extendMember) {
    ...
    const fields = [spansField, stylesField, listsField].concat(
      subTypeDef.fields || []
    )
      ...
      return {
        ...
        extend: extensionDef => {
          ...
          const current = Object.assign(
            {},
            parent,
            pick(extensionDef, INHERITED_FIELDS),
            {
              type: parent
            }
          )
    ...
    of: [
      {
        ...
        annotations:
          marks && marks.annotations ? marks.annotations : DEFAULT_ANNOTATIONS,
        decorators:
          marks && marks.decorators ? marks.decorators : DEFAULT_DECORATORS
      },
