...
const help = `
Upgrades installed Lyra modules to the latest available version within the
...
export default {
  name: 'upgrade',
  signature:
    '[MODULE_NAME] [--tag DIST_TAG] [--range SEMVER_RANGE] [--save-exact]',
  description: 'Upgrades all (or some) Lyra modules to their latest versions',
