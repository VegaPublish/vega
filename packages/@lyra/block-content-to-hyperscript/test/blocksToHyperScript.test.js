...
const runTests = require('@lyra/block-content-tests')
const internals = require('../src/internals')
const blocksToHyperScript = require('../src/index')
...
describe('internals', () => {
  ...
  test('throws on missing apiHost/dataset when encountering images', () => {
    expect(() => {
      render({
        blocks: [
          {
