...
class ImageUrlBuilder {
  ...
  // The image to be represented. Accepts a Lyra 'image'-document, 'asset'-document or
  ...
  apiHost(apiHost) {
    return this.withOptions({apiHost})
  }
...
export default function urlBuilder(options) {
  // Did we get a LyraClient?
  if (options && typeof options.clientConfig === 'object') {
    // Inherit config from client
    return new ImageUrlBuilder(null, {
      apiHost: options.clientConfig.apiHost,
