import lyraImage from '../src/builder'
import {
...
const cases = [
  {
    ...
    url: urlFor
      ...
      .url(),
    expect:
      'https://lyra.api/images/production/Tb9Ew8CXIwaY6R1kjMvI0uRR-2000x3000.jpg?rect=200,300,1600,1280&w=100&h=80'
  },

  {
    ...
    url: urlFor
      ...
      .url(),
    expect:
      'https://lyra.api/images/production/Tb9Ew8CXIwaY6R1kjMvI0uRR-2000x3000.jpg?w=100&h=80'
  },
...

  {
    ...
    url: urlFor
      ...
      .url(),
    expect:
      'https://lyra.api/images/production/Tb9Ew8CXIwaY6R1kjMvI0uRR-2000x3000.jpg?w=100&h=80&crop=center'
  },

  {
    ...
    url: urlFor
      ...
      .url(),
    expect:
      'https://lyra.api/images/production/Tb9Ew8CXIwaY6R1kjMvI0uRR-2000x3000.jpg?fp-x=10&fp-x=20&w=100&h=80'
  },

  {
    ...
    url: urlFor
      ...
      .url(),
    expect:
      'https://lyra.api/images/production/vK7bXJPEjVpL_C950gH1N73Zv14r7pYsbUdXl-4288x2848.jpg?w=80'
  },

  {
    ...
    url: urlFor
      ...
      .url(),
    expect:
      'https://lyra.api/images/production/vK7bXJPEjVpL_C950gH1N73Zv14r7pYsbUdXl-4288x2848.jpg?rect=720,0,2848,2848&w=80&h=80'
  },

  {
    ...
    url: urlFor
      ...
      .url(),
    expect:
      'https://lyra.api/images/production/Tb9Ew8CXIwaY6R1kjMvI0uRR-2000x3000.jpg?rect=200,300,1600,2400&w=320&h=240'
  },
...
describe('builder', () => {
  ...
  test('should throw on invalid fit mode', () => {
    expect(() => urlFor.image(croppedImage()).fit('moo')).toThrowError(
      /Invalid fit mode "moo"/
    )
  })

  test('should throw on invalid crop mode', () => {
    expect(() => urlFor.image(croppedImage()).crop('moo')).toThrowError(
