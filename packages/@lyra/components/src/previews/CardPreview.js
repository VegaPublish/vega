...
const fieldProp = PropTypes.oneOfType([
  PropTypes.string,
  PropTypes.node,
  PropTypes.func
])
        ...
        <div className={styles.inner}>
          {media && (
            <div className={styles.media}>
              ...
              <div
                className={
                  aspect ? styles.mediaContent : styles.mediaContentRelative
                }
              >
            ...
            <div className={styles.heading}>
              ...
              {date && (
                ...
                >
                  ...
                  {emWidth > 10 &&
                    emWidth <= 15 &&
                    formatDate(date, 'DD.MM.YY hh:mm A')}
                  {emWidth > 15 &&
                    formatDate(date, 'ddd, MMM Do, YYYY hh:mm A')}
                </div>
              )}
            </div>
            {subtitle && (
