    ...
    return (
      ...
      >
        <SplitPane
          ...
          size={size}
          resizerClassName={
            isCollapsed ? styles.ResizerIsCollapsed : styles.Resizer
          }
          allowResize
        ...
        >
          <div
            className={
              isCollapsed
                ? styles.paneInSplittedCollapsed
                : styles.paneInSplitted
            }
          >
            {pane1}
          </div>
    ...
    return (
      <div className={styles.vertical}>
        {isLessThanScreenMedium
          ? children
          : this.renderRecursivePanes(
              panes.filter(pane => pane.type !== 'div')
            )}
      </div>
    )
  }
