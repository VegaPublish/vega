...
import styles from 'part:@lyra/components/selects/searchable-style'
      ...
      <Manager>
        ...
        >
          ...
          <div className={styles.functions}>
            {openItemElement &&
              value && (
                <span className={styles.openItem}>
                ...
                <Popper
                  ...
                  modifiers={{
                    ...
                    customStyle: {
                      ...
                      fn: data => {
                        const width =
                          get(data, 'instance.reference.clientWidth') || 500
                        data.styles = {
                          ...data.styles,
                          width: width
                        }
                ...
                >
                  <div>
                    <CaptureOutsideClicks
                      onClickOutside={
                        isActive && isOpen ? this.handleClose : undefined
                      }
                    >
                      <div className={styles.listContainer}>
                        <Escapable
                          onEscape={event =>
                            (isActive || event.shiftKey) && this.handleClose()
                          }
                        />
                        {items.length === 0 &&
                          !isLoading && (
