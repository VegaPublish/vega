...
import {withRouterHOC} from 'part:@lyra/base/router'
import TrashIcon from 'part:@lyra/base/trash-icon'
import UndoIcon from 'part:@lyra/base/undo-icon'
import PublicIcon from 'part:@lyra/base/public-icon'
import BinaryIcon from 'part:@lyra/base/binary-icon'
import Menu from 'part:@lyra/components/menus/default'
import ContentCopyIcon from 'part:@lyra/base/content-copy-icon'
import documentStore from 'part:@lyra/base/datastore/document'
...
import afterEditorComponents from 'all:part:@lyra/desk-tool/after-editor-component'
import SyncIcon from 'part:@lyra/base/sync-icon'
import CheckIcon from 'part:@lyra/base/check-icon'
import CheckCircleIcon from 'part:@lyra/base/circle-check-icon'
import Snackbar from 'part:@lyra/components/snackbar/default'
import resolveProductionPreviewUrl from 'part:@lyra/transitional/production-preview/resolve-production-url?'
...
import {getPublishedId, newDraftFrom} from 'part:@lyra/base/util/draft-utils'
...
const getUnpublishItem = (draft, published, isLiveEditEnabled) => null
// isLiveEditEnabled
//   ? null
//   : {
//       action: 'unpublish',
        ...
        <div className={styles.paneFunctions}>
          {showSavingStatus && (
            <Tooltip
              ...
              size="small"
              distance="0"
              title="Syncing your content with the Lyra cloud"
            >
          ...
          {value &&
            ...
            !isReconnecting && (
              <Tooltip
                ...
                size="small"
                distance="0"
                title="Synced with the Lyra cloud"
              >
                <CheckIcon /> Synced
              </Tooltip>
            )}
            ...
            <Tooltip
              ...
              title={
                errors.length > 0
                  ...
                  : `${published ? 'Commit changes' : 'Commit'} (Ctrl+Alt+P)`
              }
            >
              <Button
          ...
          <div className={styles.root}>
            {(isCreatingDraft || isPublishing || isUnpublishing) && (
              <div className={styles.spinnerContainer}>
                {isCreatingDraft && (
                  <Spinner center message="Making changes…" />
                )}
            ...
            <form
              ...
              id="Lyra_Default_DeskTool_Editor_ScrollContainer"
            >
              <FormBuilder
                schema={schema}
