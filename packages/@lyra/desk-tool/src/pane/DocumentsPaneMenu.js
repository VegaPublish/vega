...
import IconList from 'part:@lyra/base/bars-icon'
import IconDetails from 'part:@lyra/base/th-list-icon'
import IconThumbnails from 'part:@lyra/base/th-large-icon'
// import IconSettings from 'part:@lyra/base/cog-icon'
import IconNew from 'part:@lyra/base/plus-circle-icon'
