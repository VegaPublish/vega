...
import defaultStyles from 'part:@lyra/components/fieldsets/default-style'
...
import fieldsetStyles from './styles/Fieldset.css'
...
export default class Fieldset extends React.Component {
  ...
  handleToggleValidationList = event => {
    const {showValidationList} = this.state
    this.setState({
